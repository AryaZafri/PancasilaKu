...
// UPDATE: mengubah data sesuai id yang diinginkan
...
// DELETE: menghapus data sesuai id yang diinginkan
...
// READ{ID}: menampilkan data sesuai id yang diinginkan
...
exports.getByCategoryId = async (req, res) => {
  ...
  res.json({
    message: `Quizzes retrieved successfully categoryId=${id}.`,
    data: quizzes,
  });
};
